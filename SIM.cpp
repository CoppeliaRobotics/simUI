...
#endif
#if WIDGET_DATAFLOW
    connect(this, &SIM::addNode, ui, &UI::onAddNode, Qt::BlockingQueuedConnection);
    connect(this, &SIM::removeNode, ui, &UI::onRemoveNode, Qt::BlockingQueuedConnection);
    connect(this, &SIM::setNodeValid, ui, &UI::onSetNodeValid, Qt::BlockingQueuedConnection);
    connect(this, &SIM::setNodePos, ui, &UI::onSetNodePos, Qt::BlockingQueuedConnection);
    connect(this, &SIM::setNodeText, ui, &UI::onSetNodeText, Qt::BlockingQueuedConnection);
    connect(this, &SIM::setNodeInletCount, ui, &UI::onSetNodeInletCount, Qt::BlockingQueuedConnection);
    connect(this, &SIM::setNodeOutletCount, ui, &UI::onSetNodeOutletCount, Qt::BlockingQueuedConnection);
    connect(this, &SIM::addConnection, ui, &UI::onAddConnection, Qt::BlockingQueuedConnection);
    connect(this, &SIM::removeConnection, ui, &UI::onRemoveConnection, Qt::BlockingQueuedConnection);
    connect(ui, &UI::nodeAdded, this, &SIM::onNodeAdded);
    connect(ui, &UI::nodeRemoved, this, &SIM::onNodeRemoved);
    connect(ui, &UI::nodeValidChanged, this, &SIM::onNodeValidChanged);
    connect(ui, &UI::nodePosChanged, this, &SIM::onNodePosChanged);
    connect(ui, &UI::nodeTextChanged, this, &SIM::onNodeTextChanged);
    connect(ui, &UI::nodeInletCountChanged, this, &SIM::onNodeInletCountChanged);
    connect(ui, &UI::nodeOutletCountChanged, this, &SIM::onNodeOutletCountChanged);
    connect(ui, &UI::connectionAdded, this, &SIM::onConnectionAdded);
    connect(ui, &UI::connectionRemoved, this, &SIM::onConnectionRemoved);
#endif
...
#if WIDGET_DATAFLOW
void SIM::onNodeAdded(Dataflow *dataflow, int id, QPoint pos, QString text, int inlets, int outlets)
{
    ASSERT_THREAD(!UI);
...
void SIM::onNodeRemoved(Dataflow *dataflow, int id)
{
    ASSERT_THREAD(!UI);
    CHECK_POINTER(Widget, dataflow);
...
void SIM::onNodeValidChanged(Dataflow *dataflow, int id, bool valid)
{
    ASSERT_THREAD(!UI);
    CHECK_POINTER(Widget, dataflow);
...
void SIM::onNodePosChanged(Dataflow *dataflow, int id, QPoint pos)
{
    ASSERT_THREAD(!UI);
    CHECK_POINTER(Widget, dataflow);
...
void SIM::onNodeTextChanged(Dataflow *dataflow, int id, QString text)
{
    ASSERT_THREAD(!UI);
    CHECK_POINTER(Widget, dataflow);
...
void SIM::onNodeInletCountChanged(Dataflow *dataflow, int id, int inlets)
{
    ASSERT_THREAD(!UI);
    CHECK_POINTER(Widget, dataflow);
...
void SIM::onNodeOutletCountChanged(Dataflow *dataflow, int id, int outlets)
{
    ASSERT_THREAD(!UI);
    CHECK_POINTER(Widget, dataflow);
...
void SIM::onConnectionAdded(Dataflow *dataflow, int srcNodeId, int srcOutlet, int dstNodeId, int dstInlet)
{
    ASSERT_THREAD(!UI);
    CHECK_POINTER(Widget, dataflow);
...
void SIM::onConnectionRemoved(Dataflow *dataflow, int srcNodeId, int srcOutlet, int dstNodeId, int dstInlet)
{
    ASSERT_THREAD(!UI);
    CHECK_POINTER(Widget, dataflow);
